...
static const OozeAquaPalette palette_light = {
  ...
  .menu_surface_r = 0.86, .menu_surface_g = 0.86, .menu_surface_b = 0.88,
  .menu_surface_highlight_a = 0.65,
  .menu_hover_top_r = 0.38, .menu_hover_top_g = 0.58, .menu_hover_top_b = 0.98,
  .menu_hover_mid_r = 0.22, .menu_hover_mid_g = 0.45, .menu_hover_mid_b = 0.96,
  .menu_hover_bottom_r = 0.12, .menu_hover_bottom_g = 0.34, .menu_hover_bottom_b = 0.92,
  .menu_hover_gloss_a = 0.18,
  .menu_separator_r = 0.08, .menu_separator_g = 0.08, .menu_separator_b = 0.08,
  .menu_separator_a = 0.14,
  .menu_width = 280.0, .menu_row_height = 22.0, .menu_padding = 4.0,
  .menu_separator_height = 9.0, .menu_corner = 6.0,
  .menu_label_max_width = 240.0,
...
static const OozeAquaPalette palette_dark = {
  ...
  .menu_surface_r = 0.20, .menu_surface_g = 0.20, .menu_surface_b = 0.22,
  .menu_surface_highlight_a = 0.12,
  .menu_hover_top_r = 0.38, .menu_hover_top_g = 0.58, .menu_hover_top_b = 0.98,
  .menu_hover_mid_r = 0.22, .menu_hover_mid_g = 0.45, .menu_hover_mid_b = 0.96,
  .menu_hover_bottom_r = 0.12, .menu_hover_bottom_g = 0.34, .menu_hover_bottom_b = 0.92,
  .menu_hover_gloss_a = 0.18,
  .menu_separator_r = 0.92, .menu_separator_g = 0.92, .menu_separator_b = 0.94,
  .menu_separator_a = 0.14,
  .menu_width = 280.0, .menu_row_height = 22.0, .menu_padding = 4.0,
  .menu_separator_height = 9.0, .menu_corner = 6.0,
  .menu_label_max_width = 240.0,
