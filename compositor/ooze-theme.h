...
typedef struct
{
  ...
  gdouble menu_text_g;
  gdouble menu_text_b;
  gdouble menu_surface_r;
  gdouble menu_surface_g;
  gdouble menu_surface_b;
  gdouble menu_surface_highlight_a;
  gdouble menu_hover_top_r;
  gdouble menu_hover_top_g;
  gdouble menu_hover_top_b;
  gdouble menu_hover_mid_r;
  gdouble menu_hover_mid_g;
  gdouble menu_hover_mid_b;
  gdouble menu_hover_bottom_r;
  gdouble menu_hover_bottom_g;
  gdouble menu_hover_bottom_b;
  gdouble menu_hover_gloss_a;
  gdouble menu_separator_r;
  gdouble menu_separator_g;
  gdouble menu_separator_b;
  gdouble menu_separator_a;
  gdouble menu_width;
  gdouble menu_row_height;
  gdouble menu_padding;
  gdouble menu_separator_height;
  gdouble menu_corner;
  gdouble menu_label_max_width;
