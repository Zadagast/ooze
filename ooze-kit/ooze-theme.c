...
ooze_theme_ensure (void)
{
  ...
  gtk_css_provider_load_from_string (p,
    ...
    "  padding: 4px;"
    "  border: 1px solid alpha(@window_fg_color, 0.42);"
    "  border-radius: 6px;"
    "  background: linear-gradient(to bottom,"
    "              alpha(@window_bg_color, 0.98),"
    "              alpha(@window_bg_color, 0.90));"
    "  box-shadow: 0 3px 7px alpha(black, 0.24),"
    "              0 10px 24px alpha(black, 0.20);"
    "}"
    "popover.menu > contents > scrolledwindow,"
    "popover.menu > contents > scrolledwindow viewport,"
    "popover.menu > contents > scrolledwindow viewport stack {"
    "  min-height: 0;"
    "  border: none;"
    "  background: transparent;"
    "}"
    ...
    "}"
    "popover.menu modelbutton:hover accelerator,"
    "popover.menu modelbutton:hover arrow,"
    "popover.menu modelbutton:selected accelerator,"
    "popover.menu modelbutton:selected arrow,"
    "popover.menu modelbutton:focus-visible accelerator,"
    "popover.menu modelbutton:focus-visible arrow {"
    "  color: alpha(@accent_fg_color, 0.86);"
    "}"
