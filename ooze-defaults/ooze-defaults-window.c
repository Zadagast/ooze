...
static void
ooze_defaults_window_class_init (OozeDefaultsWindowClass *klass G_GNUC_UNUSED)
{
}
...
ooze_defaults_window_init (OozeDefaultsWindow *self)
{
  ...
  gtk_window_set_title (GTK_WINDOW (self), "Default Applications");
...
{
  OozeDefaultsWindow *win;
  GMenuModel *menubar;

  win = g_object_new (OOZE_DEFAULTS_TYPE_WINDOW, "application", app, NULL);
  menubar = defaults_build_menubar ();
