...
Download the current Alpha 0.4.10 AppImage or Debian package from
...
```sh
sudo apt install ./ooze_0.4.10_amd64.deb
```
...
**Ooze is Alpha 0.4.10** — a bold, early, work-in-progress desktop that already
